...
# ---------- 上下文注入 ----------
STEP_GUIDE = {
    1: "学生正在选择实验类型：帮助确认实验选择，说明各实验适合的学习目标。",
    2: "学生正在上传/采集视频并设置参数：给出拍摄要点建议，逐项核对参数取值是否合理。",
    3: "学生正在标定坐标系：解释各标定点的含义与正确点法，提醒常见标定错误。",
    4: "学生准备/正在运行处理：确认参数合理，解释进度中的滤波、找峰等环节。",
    5: "学生已得到结果：帮其解读 CSV/角度-时间图、阻尼系数等输出，指导误差分析与报告撰写。",
}
